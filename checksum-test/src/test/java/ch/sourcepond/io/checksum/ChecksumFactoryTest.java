...
import static ch.sourcepond.io.checksum.api.ResourcesRegistry.LISTENER_EXECUTOR_ATTRIBUTE;
import static ch.sourcepond.io.checksum.api.ResourcesRegistry.UPDATE_EXECUTOR_ATTRIBUTE;
...
public class ChecksumFactoryTest {
	 ...
	 */
	@Inject
	private ResourcesRegistry factory;
